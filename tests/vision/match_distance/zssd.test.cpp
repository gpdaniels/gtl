...
// TODO: Fix tests, these are currently the results for ssd.
...
TEST(zssd, function, checker) {
    const float results_empty_checker[data_height][data_width] = {
        {     0.0,  32512.5,  43350.0,  65025,  78030.000000 },
        { 32512.5,  65025.0,  97537.5, 130050, 162562.500000 },
        { 43350.0,  97537.5, 144500.0, 195075, 242760.000000 },
        { 65025.0, 130050.0, 195075.0, 260100, 325125.000000 },
        { 78030.0, 162562.5, 242760.0, 325125, 405755.968750 }
    };
    ...
    const float results_checker_checker[data_height][data_width] = {
        {      0, 255*255* 2, 173400.0000, 255*255* 4,  312120.000 },
        { 130050, 255*255* 4, 390150.0000, 255*255* 8,  650250.000 },
        { 173400, 255*255* 6, 577999.9375, 255*255*12,  971040.000 },
        { 260100, 255*255* 8, 780300.0000, 255*255*16, 1300500.000 },
        { 312120, 255*255*10, 971040.0000, 255*255*20, 1623023.875 }
    };
...
TEST(zssd, function, gradient_1d) {
    const float results_gradient_x[data_height][data_width] = {
        { 0,  8064.5,  32512.667969,  81536.75, 162818 },
        { 0, 16129.0,  65025.335938, 163073.50, 325636 },
        { 0, 24193.5,  97538.000000, 244610.25, 488454 },
        { 0, 32258.0, 130050.664062, 326147.00, 651272 },
        { 0, 40322.5, 162563.328125, 407683.75, 814090 }
    };
    test_set(data_x_empty, data_x_fill, results_gradient_x);

    const float results_gradient_y[data_height][data_width] = {
        {      0.000000,      0.000000,      0.000000,      0.000000,      0.000000 },
        {   8064.500000,  16129.000000,  24193.500000,  32258.000000,  40322.500000 },
        {  32512.667969,  65025.335938,  97538.000000, 130050.664062, 162563.328125 },
        {  81536.750000, 163073.500000, 244610.250000, 326147.000000, 407683.750000 },
        { 162818.000000, 325636.000000, 488454.000000, 651272.000000, 814090.000000 }
    };
...
TEST(zssd, function, gradient_2d) {
    const float results_gradient[data_height][data_width] = {
        {     0.000000,  1984.500000,   8064.666504,  20288.750000,  40704.796875 },
        {  1984.500000,  8064.750000,  22336.832031,  48896.875000,  91840.898438 },
        {  8064.666504, 22336.832031,  48896.886719,  93888.921875, 163456.937500 },
        { 20288.750000, 48896.875000,  93888.921875, 163456.890625, 265792.968750 },
        { 40704.796875, 91840.898438, 163456.937500, 265792.968750, 408578.000000 }
    };
