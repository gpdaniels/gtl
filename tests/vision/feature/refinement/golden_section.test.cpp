...
TEST(golden_section, function, search_2d) {
    ...
    const float best_score_nnc = gtl::golden_section_2d<patch_width, patch_height, &gtl::sub_pixel_patch<patch_width, patch_height>, &gtl::ncc<patch_width, patch_height>>(
    ...
    const float best_score_ssd = gtl::golden_section_2d<patch_width, patch_height, &gtl::sub_pixel_patch<patch_width, patch_height>, &gtl::ssd<patch_width, patch_height>>(
        &data_lhs[start_lhs_y][start_lhs_x],
        data_width,
        &data_rhs[start_rhs_y][start_rhs_x],
        data_width,
    ...
    const float best_score_zncc = gtl::golden_section_2d<patch_width, patch_height, &gtl::sub_pixel_patch<patch_width, patch_height>, &gtl::zncc<patch_width, patch_height>>(
        &data_lhs[start_lhs_y][start_lhs_x],
        data_width,
        &data_rhs[start_rhs_y][start_rhs_x],
        data_width,
