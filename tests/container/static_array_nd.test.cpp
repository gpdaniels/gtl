                ...
                [](auto value_1) -> void {
                    ...
                    testbench::test_template<testbench::value_collection<0, 1, 10>>(
                        [](auto value_2) -> void {
                            ...
                            REQUIRE((std::is_pod<gtl::static_array_nd<type, type_value1::value, value2>>::value == true), "Expected std::is_pod to be true.");
                            REQUIRE((std::is_trivial<gtl::static_array_nd<type, type_value1::value, value2>>::value == true), "Expected std::is_trivial to be true.");
                            REQUIRE((std::is_trivially_copyable<gtl::static_array_nd<type, type_value1::value, value2>>::value == true), "Expected std::is_trivially_copyable to be true.");
                            REQUIRE((std::is_standard_layout<gtl::static_array_nd<type, type_value1::value, value2>>::value == true), "Expected std::is_standard_layout to be true.");
                            testbench::test_template<testbench::value_collection<0, 1, 10>>(
                                [](auto value_3) -> void {
                                    using type_value3 = decltype(value_3);
                                    constexpr static const unsigned long long value3 = type_value3::value;
                                    REQUIRE((std::is_pod<gtl::static_array_nd<type, type_value1::value, type_value2::value, value3>>::value == true), "Expected std::is_pod to be true.");
                                    REQUIRE((std::is_trivial<gtl::static_array_nd<type, type_value1::value, type_value2::value, value3>>::value == true), "Expected std::is_trivial to be true.");
                                    REQUIRE((std::is_trivially_copyable<gtl::static_array_nd<type, type_value1::value, type_value2::value, value3>>::value == true), "Expected std::is_trivially_copyable to be true.");
                                    REQUIRE((std::is_standard_layout<gtl::static_array_nd<type, type_value1::value, type_value2::value, value3>>::value == true), "Expected std::is_standard_layout to be true.");
                                }
                            );
                        }
                    );
                ...
                [](auto value_1) -> void {
                    ...
                    testbench::test_template<testbench::value_collection<0, 1, 10>>(
                        [](auto value_2) -> void {
                            using type_value2 = decltype(value_2);
                            constexpr static const unsigned long long value2 = type_value2::value;
                            gtl::static_array_nd<type, type_value1::value, value2> static_array_nd_2d;
                            testbench::do_not_optimise_away(static_array_nd_2d);
                            testbench::test_template<testbench::value_collection<0, 1, 10>>(
                                [](auto value_3) -> void {
                                    using type_value3 = decltype(value_3);
                                    constexpr static const unsigned long long value3 = type_value3::value;
                                    gtl::static_array_nd<type, type_value1::value, type_value2::value, value3> static_array_nd_3d;
                ...
                [](auto value_1) -> void {
                    ...
                    testbench::test_template<testbench::value_collection<0, 1, 10>>(
                        [](auto value_2) -> void {
                            ...
                            constexpr static const unsigned long long value2 = type_value2::value;
                            gtl::static_array_nd<type, type_value1::value, value2> static_array_nd_2d;
                            REQUIRE(static_array_nd_2d.size() == type_value1::value);
                            REQUIRE(static_array_nd_2d.size(0) == type_value1::value);
                            ...
                            testbench::test_template<testbench::value_collection<0, 1, 10>>(
                                [](auto value_3) -> void {
                                    ...
                                    constexpr static const unsigned long long value3 = type_value3::value;
                                    gtl::static_array_nd<type, type_value1::value, type_value2::value, value3> static_array_nd_3d;
                                    REQUIRE(static_array_nd_3d.size() == type_value1::value);
                                    REQUIRE(static_array_nd_3d.size(0) == type_value1::value);
                                    REQUIRE(static_array_nd_3d.size(1) == type_value2::value);
        ...
        [](auto test_type, auto value_1) -> void {
            ...
            testbench::test_template<testbench::value_collection<1, 10>>(
                [](auto value_2) -> void {
                    ...
                    constexpr static const unsigned long long value2 = type_value2::value;
                    for (const type& value : testbench::test_data<type>()) {
                        gtl::static_array_nd<type, type_value1::value, value2> static_array_nd_2d = { { { { value } } } };
                        testbench::do_not_optimise_away(static_array_nd_2d);
                    }
                    testbench::test_template<testbench::value_collection<1, 10>>(
                        [](auto value_3) -> void {
                            ...
                            constexpr static const unsigned long long value3 = type_value3::value;
                            for (const type& value : testbench::test_data<type>()) {
                                gtl::static_array_nd<type, type_value1::value, type_value2::value, value3> static_array_nd_3d = { { { { { { value } } } } } };
                                testbench::do_not_optimise_away(static_array_nd_3d);
                            }
                        }
                    );
